    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/Image/Logo/Developer_Portal.svg" 
    ...
    <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--tailwind-neutra-900, #171717)' }}>
      ...
      >
        ...
        >
          ...
          >
            Select a workspace to enter the Developer Portal. You can switch later from the sidebar.
          </p>
        </div>
...
export default DeveloperPortalEntry;